...
import { requireCond } from '../utils/utils'
...
export class MempoolManager {
    ...
    addUserOp(
        ...
        if (index !== -1) {
            ...
            this.entryCount[userOp.sender] =
                (this.entryCount[userOp.sender] ?? 0) + 1
    ...
    private updateSeenStatus(
        ...
        this.reputationManager.updateSeenStatus(
    ...
    private checkSenderCountInMempool(
        ...
        if (
            (this.entryCount[userOp.sender] ?? 0) >
